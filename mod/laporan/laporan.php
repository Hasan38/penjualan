			...
			case 'penjualan':
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php?mod=lappjperiode' method='post' target='_blank'>
							<table>
								<tr>
									<td>Tanggal Dari :</td>
					...
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-yellow'>
							<h4>Rekap Penjualan Per-Tahun</h4>
						</div>

						<form action='popup/popup.php?mod=lappjtahunan' method='post' target='_blank'>
							<table>
								<tr>
									<td>Pilih Tahun</td>
									<td><select name='tahun' class='w3-select'>";
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-orange'>
							<h4>Rekap Penjualan Barang Per-Hari</h4>
						</div>

						<form action='popup/popup.php?mod=lappjperhari' method='post' target='_blank'>
							<table>
								<tr>
									<td>Tanggal :</td>
					...
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-red'>
							<h4>Rekap Penjualan Barang Per-Periode</h4>
						</div>

						<form action='popup/popup.php?mod=lappjbarangperperiode' method='post' target='_blank'>
							<table>
								<tr>
									<td>Tanggal Dari :</td>
									<td><input type='text' name='tgl1' id='tgl3' class='w3-input w3-small' placeholder='yyyy-mm-dd' readonly></td>
									<td>s/d</td>
									<td><input type='text' name='tgl2' id='tgl4' class='w3-input w3-small' placeholder='yyyy-mm-dd' readonly></td>
								</tr>
								<tr>
									<td colspan='4'><button type='submit' class='w3-btn' name='submit' value='Cetak'>Cetak</button>
								</tr>
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-grey'>
							<h4>Rekap Bayar Hutang Penjualan Per-Hari</h4>
						</div>

						<form action='popup/popup.php?mod=laphutangperhari' method='post' target='_blank'>
							<table>
								<tr>
									<td>Tanggal :</td>
									<td><input type='text' name='tgl' class='w3-input w3-small dp' placeholder='yyyy-mm-dd' readonly></td>
					...
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-pink'>
							<h4>Rekap Bayar Hutang Penjualan Per-Periode</h4>
						</div>

						<form action='popup/popup.php?mod=laphutangperperiode' method='post' target='_blank'>
							<table>
								<tr>
									<td>Tanggal Dari :</td>
									<td><input type='text' name='tgl1' id='tgl5' class='w3-input w3-small' placeholder='yyyy-mm-dd' readonly></td>
									<td>s/d</td>
									<td><input type='text' name='tgl2' id='tgl6' class='w3-input w3-small' placeholder='yyyy-mm-dd' readonly></td>
								</tr>
								<tr>
									<td colspan='4'><button type='submit' class='w3-btn' name='submit' value='Cetak'>Cetak</button>
								</tr>
			...
			case 'barang':
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php?mod=laplarisbrgbln' method='post' target='_blank'>
							<table>
								<tr>
									<td>Pilih Bulan :</td>
					...
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php?mod=lapjthtempo' method='post' target='_blank'>
							<table>
								<tr>
									<td>Tanggal :</td>
									<td><input type='text' name='tgl' class='w3-input w3-small dp' placeholder='yyyy-mm-dd' readonly></td>
